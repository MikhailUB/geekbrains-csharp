...
namespace AsteroidsGame
{
	...
	{
		/// <summary>
		/// Делегат для событий с объектами
		/// </summary>
		public delegate void Message();
		/// <summary>
		/// Делегат для событий с описанием события
		/// </summary>
		public delegate void MessageExt(string description);

		/// <summary>
		/// Событие столкновения объектов
		/// </summary>
		public static event MessageExt ObjCollision;
		/// <summary>
		/// Позиция объекта
		/// </summary>
		protected Point Pos;
		...
		{
			var isCollision = obj.Rect.IntersectsWith(Rect);
			if (isCollision)
				ObjCollision?.Invoke($"Столкновение {GetType().Name} c {obj.GetType().Name}.");
